...
class Trainer:
	...
	def save_models(self, msg, episode_count):
		...
		:return:
		"""
		torch.save(self.target_actor.state_dict(), './linearNet/Models/' + msg + "_" +str(episode_count) + '_actor.pt')
		torch.save(self.target_critic.state_dict(), './linearNet/Models/' + msg + "_" + str(episode_count) + '_critic.pt')
	...
	def load_models(self, msg, episode):
		...
		:return:
		"""
		self.actor.load_state_dict(torch.load('./linearNet/Models/' + msg + "_" + str(episode) + '_actor.pt'))
		self.critic.load_state_dict(torch.load('./linearNet/Models/' + msg + "_" + str(episode) + '_critic.pt'))
		utils.hard_update(self.target_actor, self.actor)
		utils.hard_update(self.target_critic, self.critic)
